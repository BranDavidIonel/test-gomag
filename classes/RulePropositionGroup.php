	...
	class RulePropositionGroup extends RuleOperation
	{
		...
		public function __construct()
		{
			...
			if(count($args) == 2)
			{
				...
				{
					throw new ApplicationException('RulePropositionGroup Class: Invalid operator');
				}
				...
				foreach($args as $item)
				{
					...
					{
						throw new ApplicationException('RuleProposition Class: Invalid proposition in group');
					}
				}
